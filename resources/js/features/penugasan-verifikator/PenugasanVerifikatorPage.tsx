...
export function PenugasanVerifikatorPage() {
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <ConfirmDialog
                ...
                title="Cabut Role Verifikator"
                message="Apakah Anda yakin ingin mencabut role Verifikator dari dosen ini? Dosen tidak akan lagi dapat memverifikasi soal di periode ini. Tindakan ini dapat dibatalkan dengan menugaskannya kembali."
                confirmLabel="Cabut"
            />
        </div>
    );
