...
import { Search, X, BookOpen, UserCheck, ChevronDown, CheckSquare } from 'lucide-react';
...
export function AssignModal({
    ...
    return (
        <Modal
            open={open}
            onClose={onClose}
            title="Tugaskan Dosen sebagai Verifikator Soal"
            size="lg"
            footer={
                <>
                    <button
        ...
        >
            ...
            >
                ...
                <div className="rounded-xl border border-blue-100 bg-blue-50/60 p-3 text-xs text-blue-900 flex items-start gap-2.5">
                    ...
                    <div>
                        <span className="font-semibold">Peran Verifikator Soal:</span> Dosen yang ditugaskan akan mendapatkan kewenangan untuk memverifikasi naskah soal ujian pada mata kuliah yang dipilih dalam periode aktif.
                    </div>
                </div>

                {/* Periode */}
                <div>
                    <label htmlFor="assign-v-periode" className="block text-sm font-medium text-gray-700">
                ...
                <div className="relative">
                    <div className="flex items-center justify-between">
                        <label className="block text-sm font-medium text-gray-700">
                            Mata Kuliah yang Diverifikasi <span className="text-red-500">*</span>
                        </label>
                        <button
                            type="button"
                            ...
                            className={cn(
                                ...
                                isAllCourses
                                    ...
                                    : "text-gray-500 hover:text-blue-700 underline"
                            )}
                        >
                            ...
                            {filteredCourses.length > 0 ? (
                                filteredCourses.map((c) => (
                                    <li
                                        ...
                                        className="cursor-pointer px-3.5 py-2.5 hover:bg-blue-50/40 text-gray-700 transition-colors flex items-center justify-between"
                                    >
                                        <div>
                ...
                {/* Dosen Verifikator Selection */}
                <div className="relative">
                    <label className="block text-sm font-medium text-gray-700">
                        Dosen yang Ditugaskan sebagai Verifikator Soal <span className="text-red-500">*</span>
                    </label>
                    <p className="mt-0.5 text-xs text-gray-400">
                        Pilih satu atau lebih dosen yang ingin dijadikan Verifikator Soal.
                    </p>
                    ...
                    {selectedDosen.length > 0 && (
                        <div className="mt-2.5 flex flex-wrap gap-2 rounded-lg border border-blue-100 bg-blue-50/30 p-2.5">
                            {selectedDosen.map((d) => (
                                <span
                                    key={d.id}
                                    className="inline-flex items-center gap-1.5 rounded-lg bg-white border border-blue-200 pl-2.5 pr-1.5 py-1 text-xs font-medium text-gray-800 shadow-sm"
                                >
                            ...
                            {filteredDosen.length > 0 ? (
                                filteredDosen.map((d) => (
                                    <li
                                        ...
                                        className="cursor-pointer px-3.5 py-2.5 hover:bg-blue-50/40 text-gray-700 transition-colors"
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
